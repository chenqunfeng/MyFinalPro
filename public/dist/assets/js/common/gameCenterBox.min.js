...
var GameCenterBox, com,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

com = require("./pubComponent.coffee");

GameCenterBox = (function(superClass) {
  extend(GameCenterBox, superClass);

  function GameCenterBox(config) {
    GameCenterBox.__super__.constructor.call(this);
    this.init(config);
  }

  GameCenterBox.prototype.init = function(config) {
    this.setConfig(config);
    return console.log(1);
  };

  GameCenterBox.prototype.setConfig = function(config) {
    if (config) {
      this.config = config;
    }
    return this;
