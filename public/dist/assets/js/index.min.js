...
},{"./pubComponent.coffee":2}],4:[function(require,module,exports){
var login, loginBox, register, registerBox;
...
$(document).on("click", ".loging, .toLogin", function() {
  login.open();
  return register.close();
});

$(document).on("click", ".registing, .toRegister", function() {
  login.close();
  return register.open();
});


},{"./common/loginComponent.coffee":1,"./common/registerComponent.coffee":3}]},{},[4])